...
int convert_utf8(int code)
{
	...
	static WORD utf8_table[]={
		...
		0xA7,0x00BA,
		0xA8,0x00BF,
		0xA9,0x2310, //REVERSED NOT SIGN : beginning of line
		0xAA,0x00AC,
		0xAB,0x00BD,
		0xAC,0x00BC,
		0xAD,0x00A1,
		...
		0xB4,0x2524, //BOX DRAWINGS HEAVY VERTICAL AND RIGHT
		0xB5,0x2561,
		0xB6,0x2562,
		0xB7,0x2556,
		0xB8,0x2555,
		...
		0xDF,0x2580,
		0xE0,0x03B1,
		0xE1,0x00DF, //GREEK SMALL LETTER ALPHA
		0xE2,0x0393,
		0xE3,0x03C0,
		0xE4,0x03A3,
		0xE5,0x03C3,
		...
		0xFF,0x00A0  //NO-BREAK SPACE [NBSP]
	};
